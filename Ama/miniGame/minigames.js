...
var   cell61 = document.getElementById("cell61").value,
  ...
  if  (cell37 != 3 ||  cell37 != 4 ||  cell37 != 6 ||  cell37 != 9 || cell37!=7  || cell37 !=='')
  { document.getElementById("cell37").style.background = 'red';
  score = score-1;}
  if(cell37 == 3 ||  cell37 == 4 ||  cell37 == 6 || cell37 ==7 || cell37 == 9) 
  ...
  if(cell57 != 1 ||  cell57 != 3 || cell57 != 4 || cell57 != 6 ||  cell57 != 7 || cell57 !=='')
  { document.getElementById("cell57").style.background = 'red';
  score = score-1;}
  if(cell57 == 1 ||  cell57 == 3 || cell57 == 4 ||  cell57 == 6 ||  cell57 == 7)
