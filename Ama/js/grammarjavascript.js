function displaySPrTFullex()  /*display simple present tense full verbs examples*/
    {
        ...
        document.getElementById("SPrTF-color-change").style.background='silver';
    }
    function displaySPrTBEex()
    {
        ...
        document.getElementById("SPrTB-color-change").style.background='silver';
    }
    function displaySPTFullex()
    {
        ...
        document.getElementById("SPTF-color-change").style.background='silver';
    }
    function displaySPTBeEx()
    {
        ...
        document.getElementById("SPTB-color-change").style.background='silver';
    }
    function displaySFTEx()
    {
        ...
        document.getElementById("SFT-color-change").style.background='silver';
    }
    function displayPrCTEx()
    {
        ...
        document.getElementById("PrCT-color-change").style.background='silver';
    }
    ...
    function displayPCTEx()
    {
        ...
        document.getElementById("PCT-color-change").style.background='silver';
    }
    function displayFCTEx()
    {
        ...
        document.getElementById("FCT-color-change").style.background='silver';
    }
    function displayPrPTEx()
    {
        ...
        document.getElementById("PrPT-color-change").style.background='silver';
    }
    function displayPPTEx()
    {
        ...
        document.getElementById("PPT-color-change").style.background='silver';
    }
    function displayFPTEx()
    {
        ...
        document.getElementById("FPT-color-change").style.background='silver';
    }
    function displayPrPCT()
    {
        ...
        document.getElementById("PrPCT-color-change").style.background='silver';
    }
   function displayPPCT()
    {
        ...
        document.getElementById("PPCT-color-change").style.background='silver';
    }
    function displayFPCT()
    {
        ...
        document.getElementById("FPCT-color-change").style.background='silver';
    }